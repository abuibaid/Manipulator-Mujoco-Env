...
class OperationalSpaceController(JointEffortController):
    def __init__(
        ...
        self._eef_id = model.site(eef_site).id
        # self._jnt_dof_ids = [model.joint(joint_name).dofadr for joint_name in joints]
    ...
    def run(self, target):
        ...
        # print("M_full shape:", M_full.shape)
        # print("self._jnt_dof_ids:", self._jnt_dof_ids)
        ...
        dq = self._data.qvel[self._jnt_dof_ids]
