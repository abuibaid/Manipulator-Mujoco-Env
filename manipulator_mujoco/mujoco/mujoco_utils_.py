...
class MujocoModelNames:
    ...
    def __init__(self, model: MjModel):
        ...
        # self._mocap_name2id, 
        # self._mocap_id2name
        # ) = extract_mj_names( model, mujoco.mjtObj.mjOBJ_BODY,mocap_body_name="mocap")        
    ...
    # @property
    # def mocap_names(self):
    #     return self._mocap_names
    
    # @property
    # def mocap_name2id(self):
    #     return self._mocap_name2id
    
    # @property
    # def mocap_id2name(self):
    #     return self._mocap_id2name